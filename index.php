...
<head>
    ...
    <!-- Website Title -->
    <title>Latrosoft - Business HTML Landing Page Template</title>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle page-scroll" href="#tour" id="navbarDropdown" role="button" Latrosoft-haspopup="true" Latrosoft-expanded="false">TOUR</a>
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#testi">TESTIMONIAL</a>
                </li>
...
<?php            }
                ...
                <div class="row">
                    <div class="col-lg-12 mb-lg-4">
                        <div class="text-container">
                            <h1>Ultimate Travelling Experience</h1>
                            <p class=" p-large">Journey as great as the destination. Just a smile away. Let the team of FOX-SAFARI show you the hidden </p>
  ...
  <!-- Project Lightboxes -->
    ...
    <!-- Intro -->
    <div id="tour" class="basic-1">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="text-container">
                        <div class="section-title">Inside Tour</div>
                        <h2>Adventure is waiting!</h2>
                        <p>Tierd of watching ferocious and majestic animals on your television sets? then, take a call to watch them live in front of you by paying a visit to some of the majestic wildlife sancturies and national parks in the world. </p>
                        <p class="testimonial-text">"To travel is to take a journey into yourself."</p>
                        <div class="testimonial-author">- Danny Kaye</div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-7 col-xl-6">
                <div class="text-container">
                    <div class="section-title">Outside Tour</div>
                    <h2>Tourists visit. Travellers explore.</h2>
                    <p>World's wildlife sanctuaries and national parks are the place for a perfect safari tour and exploring the nature's beauty.We provide an exclusive offers for safari hunting and tourism around the world.</p>
                    <ul class="list-unstyled li-space-lg">
                        <li class="media">
                            <i class="fas fa-square"></i>
                            <div class="media-body">The best time to embark on a safari tour and collect life enriching experience with us.</div>
                        </li>
                        <li class="media">
                            <i class="fas fa-square"></i>
                            <div class="media-body">Wherever you go, go with all your heart.</div>
                        </li>
                    </ul>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>hiiii  kkkk  lll et consectetur adipisicing elit. Quaerat, atque?</p>
                        </div>
                    </div>
            ...
            <div class="col-lg-6">
                ...
                <form id="callMeForm" data-toggle="validator" data-focus="false">
                    ...
                    <div class="form-group checkbox white">
                        <input type="checkbox" id="lterms" value="Agreed-to-Terms" name="lterms" required>I agree with Latrosoft's stated <a class="white" href="privacy-policy.html">Privacy Policy</a> and <a class="white" href="terms-conditions.html">Terms & Conditions</a>
                        <div class="help-block with-errors"></div>
                    </div>
                    <div class="form-group">
	...
	<div id="details" class="accordion">
		<div class="area-1">
            ...
            <div class="accordion-container" id="accordionOne">
                ...
                <div class="item">
                    <div id="headingOne">
                        <span data-toggle="collapse" data-target="#collapseOne" Latrosoft-expanded="true" Latrosoft-controls="collapseOne" role="button">
                            <span class="circle-numbering">1</span><span class="accordion-title">How Can Latrosoft Help Your Business</span>
                        </span>
                    </div>
                    <div id="collapseOne" class="collapse show" Latrosoft-labelledby="headingOne" data-parent="#accordionOne">
                        <div class="accordion-body">
                            At Latrosoft solutions, we’ve taken the consultancy concept one step further by offering a full service management organization with expertise.
                        </div>
                    </div>
                </div> 
                ...
                <div class="item">
                    <div id="headingTwo">
                        <span class="collapsed" data-toggle="collapse" data-target="#collapseTwo" Latrosoft-expanded="false" Latrosoft-controls="collapseTwo" role="button">
                            <span class="circle-numbering">2</span><span class="accordion-title">Great Strategic Business Planning</span>
                        </span>
                    </div>
                    <div id="collapseTwo" class="collapse" Latrosoft-labelledby="headingTwo" data-parent="#accordionOne">
                        <div class="accordion-body">
                            Latrosoft partners with businesses to business growth and development ideas including environment analysis, plan execution and evaluation.
                        </div>
                    </div>
                </div> 
                ...
                <div class="item">
                    <div id="headingThree">
                        <span class="collapsed" data-toggle="collapse" data-target="#collapseThree" Latrosoft-expanded="false" Latrosoft-controls="collapseThree" role="button">
                            <span class="circle-numbering">3</span><span class="accordion-title">Online Marketing Campaigns</span>
                        </span>
                    </div>
                    <div id="collapseThree" class="collapse" Latrosoft-labelledby="headingThree" data-parent="#accordionOne">
                        <div class="accordion-body">
	...
	<div class="tabs">
        <div class="area-1">
            <div class="tabs-container">
                ...
                <ul class="nav nav-tabs" id="LatrosoftTabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="nav-tab-1" data-toggle="tab" href="#tab-1" role="tab" Latrosoft-controls="tab-1" Latrosoft-selected="true"><i class="fas fa-th"></i> Business</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="nav-tab-2" data-toggle="tab" href="#tab-2" role="tab" Latrosoft-controls="tab-2" Latrosoft-selected="false"><i class="fas fa-th"></i> Expertise</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="nav-tab-3" data-toggle="tab" href="#tab-3" role="tab" Latrosoft-controls="tab-3" Latrosoft-selected="false"><i class="fas fa-th"></i> Quality</a>
                    </li>
                </ul>
               
                <div class="tab-content" id="LatrosoftTabsContent">

                    <div class="tab-pane fade show active" id="tab-1" role="tabpanel" Latrosoft-labelledby="tab-1">
                        <h4>Business Services For Companies</h4>
                        <p>Latrosoft provides the most innovative and customized business services in the industry. Our <a class="green page-scroll" href="#services">Services</a> section shows how flexible we are for all types of budgets.</p>
                        
                       
                        <div class="progress-container">
                            <div class="title">Business Development 100%</div>
                            <div class="progress">
                                <div class="progress-bar first" role="progressbar" Latrosoft-valuenow="0" Latrosoft-valuemin="0" Latrosoft-valuemax="100"></div>
                            </div>
                            <div class="title">Opportunity Spotting 76%</div>
                            <div class="progress">
                                <div class="progress-bar second" role="progressbar" Latrosoft-valuenow="75" Latrosoft-valuemin="0" Latrosoft-valuemax="100"></div>
                            </div>
                            <div class="title">Online Marketing 90%</div>
                            <div class="progress">
                                <div class="progress-bar third" role="progressbar" Latrosoft-valuenow="90" Latrosoft-valuemin="0" Latrosoft-valuemax="100"></div>
                            </div>
                        </div>
                      
                        
                   
                    <div class="tab-pane fade" id="tab-2" role="tabpanel" Latrosoft-labelledby="tab-2">
                    ...
                    <div class="tab-pane fade" id="tab-3" role="tabpanel" Latrosoft-labelledby="tab-3">
...
<!-- Gallery -->
		...
		<div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h2>Gallery That We're Proud Of</h2>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
    ...
    <div id="project-1" class="lightbox-basic zoom-anim-dialog mfp-hide">
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <p>Need a solid foundation for your business growth plans? Latrosoft will help you manage sales and meet your current needs</p>
                <p>By offering the best professional services and quality products in the market. Don't hesitate and get in touch with us.</p>
                <div class="testimonial-container">
                    <p class="testimonial-text">Need a solid foundation for your business growth plans? Latrosoft will help you manage sales and meet your current requirements.</p>
                    <p class="testimonial-author">General Manager</p>
                </div>
                <a class="btn-solid-reg" href="#your-link">DETAILS</a> <a class="btn-outline-reg mfp-close as-button" href="#Gallery">BACK</a> 
            </div> <!-- end of col -->
        </div> <!-- end of row -->
    </div> <!-- end of lightbox-basic -->
    <!-- end of lightbox -->
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="testimonial-text">The guys from Latrosoft helped with getting my business off the ground and turning into a profitable company.</div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="testimonial-text">Latrosoft's CEO personally attends client meetings and gives his feedback on business growth strategies.</div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="testimonial-text">I recommend Latrosoft to every business owner or growth leader that wants to take his company to the next level.</div>
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="testimonial-text">My goals for using Latrosoft's services seemed high when I first set them but they've met them with no problems.</div>
                ...
                <div class="col-lg-6">
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg">
                            ...
                            <li><i class="fas fa-envelope"></i><a href="mailto:office@Latrosoft.com">office@Latrosoft.com</a></li>
                        </ul>
                        <h3>Follow Latrosoft On Social Media</h3>
                ...
                <div class="col-lg-6">
                    ...
                    <form id="contactForm" data-toggle="validator" data-focus="false">
                        ...
                        <div class="form-group checkbox">
                            <input type="checkbox" id="cterms" value="Agreed-to-Terms" required>I agree with Latrosoft's stated <a href="privacy-policy.html">Privacy Policy</a> and <a href="terms-conditions.html">Terms Conditions</a> 
                            <div class="help-block with-errors"></div>
                        </div>
                        <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg white">
                            <li>
                                <a class="white" href="#your-link">latrosoft.tech</a>
                            </li>
                            <li>
    ...
    <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <p class="p-small">Copyright © 2020 <a href="https://latrosoft.tech">Latrosoft</a></p>
                </div> <!-- end of col -->
            </div> <!-- enf of row -->
        </div> <!-- end of container -->
