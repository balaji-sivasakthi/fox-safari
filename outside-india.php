            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumbs">
                        <a href="index.html">Home</a><i class="fa fa-angle-double-right"></i><span>Outside India</span>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-container">
                        ...
                        <p>Wildlife tourism is an important part of the tourism industries in many countries including mnay African and South American countries, Australia, India, Canada, Iodonesia, Bangladesh, Malaysia, Sri Lanka and Maldives among many. It has experienced a dramatic and rapid growth in recent years worldwide and many elements are closely aligned to eco-tourism and sustainable tourism. </p>
                        <div class="row">
                            <div class="col-md-6">
