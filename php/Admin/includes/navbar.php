...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
    ...
    <div class="sidebar-brand-text mx-3">Fox Safaries Admin</div>
</a>
...
<li class="nav-item active">
    <a class="nav-link" href="/php/Admin/index.php">
...
<div class="sidebar-card">
    ...
    <p class="text-center mb-2"><strong>Fox Safaries Admin Pro</strong> is packed with premium features, components, and more!</p>
    <a class="btn btn-success btn-sm" href="https://latrosoft.com">Upgrade to Pro!</a>
</div>
