...
<?php include('./includes/top-bar.php');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h4 ml-2 mb-0 text-gray-800">Gallery Inside </h1>
                    </div>
                                    ...
                                    <?php
                                       ...
                                       if(mysqli_num_rows($tr)>0)
                                       {
                                           ...
                                           <tr>
                                                    ...
                                                    <div class="modal fade" id="picture-<?php echo $id; ?>" tabindex="-1" aria-labelledby="image-preview" aria-hidden="true">
                                                      <div class="modal-dialog">
                                                        <div class="modal-content">
                                                          ...
                                                          <div class="modal-body">
                                                            <img style="width: 100%; height:100%" src="/php/Admin/gallery/inside/<?php echo $image_path;?>" alt="">
                                                          </div>
                                                          <div class="modal-footer">
                                              ...
                                              <img style="cursor: pointer;" data-toggle="modal" data-target="#picture-<?php echo $id;?>"  src="/php/Admin/gallery/inside/<?php echo $image_path;?>" width="200" height="100">
                                               </td>
